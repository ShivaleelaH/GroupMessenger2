...
public class GroupMessengerProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        catch (Exception e) { Log.e(TAG, "File write failed"); }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        try {
            ...
            while((temp = bufferReader.readLine()) != null){
                file_value = file_value + temp;
            }
            Log.v("file_value :=",file_value);
            matrixCursor.addRow(new Object[] {selection, file_value.toString()});
        } 
        catch (Exception e) { Log.e(TAG, "File read failed"); }
